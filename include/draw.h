...
#define CHAN3(a, b, c, d, e, f)                                                \
	(CHAN2((a), (b), (c), (d)) << 8 | __DC((e), (f)))
#define CHAN4(a, b, c, d, e, f, g, h)                                          \
	(CHAN3((a), (b), (c), (d), (e), (f)) << 8 | __DC((g), (h)))
...
enum {
	...
	ARGB32 =
	    CHAN4(CAlpha, 8, CRed, 8, CGreen, 8, CBlue, 8), /* stupid VGAs */
...
struct Font {
	...
	/* on hi-dpi systems, one of these is set to f and the other is the
	 * other-dpi version of f */
	Font *lodpi;
	Font *hidpi;
};
 ...
 * Image management
 */
extern Image *_allocimage(Image *, Display *, Rectangle, u32int, int, u32int,
			  int, int);
...
extern int    geninitdraw(char *, void (*)(Display *, char *), char *, char *,
			  char *, int);
...
extern void  polyop(Image *, Point *, int, int, int, int, Image *, Point,
		    Drawop);
...
extern Point runestringop(Image *, Point, Image *, Point, Font *, Rune *,
			  Drawop);
extern Point runestringn(Image *, Point, Image *, Point, Font *, Rune *, int);
extern Point runestringnop(Image *, Point, Image *, Point, Font *, Rune *, int,
			   Drawop);
extern Point stringbg(Image *, Point, Image *, Point, Font *, char *, Image *,
		      Point);
extern Point stringbgop(Image *, Point, Image *, Point, Font *, char *, Image *,
			Point, Drawop);
extern Point stringnbg(Image *, Point, Image *, Point, Font *, char *, int,
		       Image *, Point);
extern Point stringnbgop(Image *, Point, Image *, Point, Font *, char *, int,
			 Image *, Point, Drawop);
extern Point runestringbg(Image *, Point, Image *, Point, Font *, Rune *,
			  Image *, Point);
extern Point runestringbgop(Image *, Point, Image *, Point, Font *, Rune *,
			    Image *, Point, Drawop);
extern Point runestringnbg(Image *, Point, Image *, Point, Font *, Rune *, int,
			   Image *, Point);
...
extern Point _string(Image *, Point, Image *, Point, Font *, char *, Rune *,
		     int, Rectangle, Image *, Point, Drawop);
extern Point stringsubfont(Image *, Point, Image *, Subfont *, char *);
extern int   bezier(Image *, Point, Point, Point, Point, int, int, int, Image *,
		    Point);
extern int bezierop(Image *, Point, Point, Point, Point, int, int, int, Image *,
		    Point, Drawop);
extern int bezspline(Image *, Point *, int, int, int, int, Image *, Point);
extern int bezsplineop(Image *, Point *, int, int, int, int, Image *, Point,
		       Drawop);
extern int bezsplinepts(Point *, int, Point **);
extern int fillbezier(Image *, Point, Point, Point, Point, int, Image *, Point);
extern int fillbezierop(Image *, Point, Point, Point, Point, int, Image *,
			Point, Drawop);
...
extern void needdisplay(
    void); /* call instead of initdraw to get (null) variable linked in */
