...
static KeySym nametokeysym(const char *n) {
	KeySym k, l, u;
...
static int dirsnarfselection(const char *s1, const char *s2, const char *s3,
			     const char *s4, const char *s5) {
...
static int dirchord(const char *s1, const char *s2, const char *s3,
		    const char *s4, const char *s5) {
	return installchord(buttontomask(s1), buttontomask(s2),
			    nametocommand(s3), nametotarget(s4), s5);
}

static int dirraw(const char *s1, const char *s2, const char *s3,
		  const char *s4, const char *s5) {
	return installbinding(modtomask(s1), nametokeysym(s2), Kraw,
			      strtol(s3, NULL, 16), NULL);
}
...
static int dirbind(const char *s1, const char *s2, const char *s3,
		   const char *s4, const char *s5) {
	return installbinding(modtomask(s1), nametokeysym(s2), Kcommand,
			      nametocommand(s3), s4);
}

static int dirunbind(const char *s1, const char *s2, const char *s3,
		     const char *s4, const char *s5) {
	return removebinding(modtomask(s1), nametokeysym(s2));
}

static int dirunchord(const char *s1, const char *s2, const char *s3,
		      const char *s4, const char *s5) {
...
static int dircomment(const char *s1, const char *s2, const char *s3,
		      const char *s4, const char *s5) {
	return 0;
}
