...
static long _iodial(va_list *arg) {
	char *addr, *local, *dir;
	int  *cdfp, fd;
...
static long _ioopen(va_list *arg) {
	char *path;
	int   mode;
...
static long _ioreadn(va_list *arg) {
	int   fd;
	void *a;
	long  n;
...
static long _iosleep(va_list *arg) {
	long n;
...
int iosleep(Ioproc *io, long n) { return iocall(io, _iosleep, n); }

static long _iowrite(va_list *arg) {
	int   fd;
	void *a;
	long  n, nn;
...
static long _iosendfd(va_list *arg) {
	int n, fd, fd2;
...
int iosendfd(Ioproc *io, int fd, int fd2) {
	return iocall(io, _iosendfd, fd, fd2);
}

static long _iorecvfd(va_list *arg) {
	int n, fd;
...
int iorecvfd(Ioproc *io, int fd) { return iocall(io, _iorecvfd, fd); }

static long _ioread9pmsg(va_list *arg) {
	int   fd;
	void *a;
	int   n;
...
int ioread9pmsg(Ioproc *io, int fd, void *a, int n) {
