...
Screen *publicscreen(Display *d, int id, u32int chan) {
	uchar  *a;
	Screen *s;
...
static void topbottom(Image **w, int n, int top) {
	int      i;
	uchar   *b;
	Display *d;
...
void bottomnwindows(Image **w, int n) { topbottom(w, n, 0); }

void topnwindows(Image **w, int n) { topbottom(w, n, 1); }
