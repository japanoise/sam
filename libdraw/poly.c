...
static uchar *addcoord(uchar *p, int oldx, int newx) {
	int dx;
...
static void dopoly(int cmd, Image *dst, Point *pp, int np, int end0, int end1,
...
void poly(Image *dst, Point *p, int np, int end0, int end1, int radius,
	  Image *src, Point sp) {
	dopoly('p', dst, p, np, end0, end1, radius, src, &sp, SoverD);
}

void polyop(Image *dst, Point *p, int np, int end0, int end1, int radius,
...
void fillpolyop(Image *dst, Point *p, int np, int wind, Image *src, Point sp,
		Drawop op) {
