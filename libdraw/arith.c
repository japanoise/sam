...
int eqpt(Point p, Point q) { return p.x == q.x && p.y == q.y; }
...
void combinerect(Rectangle *r1, Rectangle r2) {
...
u32int setalpha(u32int color, uchar alpha) {
	int red, green, blue;
