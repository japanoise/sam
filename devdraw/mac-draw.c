...
void freememimage(Memimage *i) { _freememimage(i); }

void memfillcolor(Memimage *i, u32int val) { _memfillcolor(i, val); }
...
u32int pixelbits(Memimage *m, Point p) { return _pixelbits(m, p); }
